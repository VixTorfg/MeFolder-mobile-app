export type FileVideoExtension =
  | "mp4"
  | "avi"
  | "mov"
  | "mkv"
...
export type FileExtensionWithoutVideo = Exclude<
  FileExtension,
  FileVideoExtension
>;
...
export const MIME_TO_CATEGORY_MAP: Record<string, FileCategory> =
  Object.entries(EXTENSION_MIME_MAP).reduce(
    (acc, [ext, mime]) => {
