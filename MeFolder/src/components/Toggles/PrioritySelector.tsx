    ...
    <View style={styles.container}>
      {PRIORITIES.map((option) => {
        ...
        return (
          <TouchableOpacity
            key={option.value}
            style={[styles.option, isActive && styles[`${option.value}Option`]]}
          ...
          >
            ...
            >
              <Ionicons
                ...
                size={18}
                color={
                  isActive ? styles.iconActive.color : styles.iconInactive.color
                }
              />
            </View>
            <Text
              style={[styles.label, isActive && styles[`${option.value}Label`]]}
            >
              {option.label}
            </Text>
            {isActive && (
