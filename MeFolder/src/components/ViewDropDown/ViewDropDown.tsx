import { View, TouchableOpacity, Dimensions, Text, Modal, Animated, Switch } from 'react-native';
            ...
            >
              <View style={styles.dropdownContainer}>
                ...
                >
                  {showOptionsPanel ? (
                    <>
                      <View style={styles.dropdownHeader}>
                        ...
                        >
                          <Ionicons name="chevron-back-outline" size={responsive.iconSize * 0.45} style={styles.IconColor} />
                          <Text style={styles.dropdownTitle}>Mostrar</Text>
                        </TouchableOpacity>
                      </View>
                      <View style={styles.dropdownItem}>
                        <Ionicons name="text-outline" size={responsive.iconSize * 0.55} style={styles.IconColor} />
                        <Text style={styles.itemText}>Extensiones</Text>
                        <Switch
                          value={viewOptions.showExtension}
                          onValueChange={(value) => onViewOptionsChange?.({ ...viewOptions, showExtension: value })}
                        />
                      </View>
                      <View style={styles.dropdownItem}>
                        <Ionicons name="eye-off-outline" size={responsive.iconSize * 0.55} style={styles.IconColor} />
                        <Text style={styles.itemText}>Archivos ocultos</Text>
                        <Switch
                          value={viewOptions.showHiddenFiles}
                          onValueChange={(value) => onViewOptionsChange?.({ ...viewOptions, showHiddenFiles: value })}
                        />
                      </View>
                    </>
                  ) : (
                  ...
                  >
                    <Ionicons name="options-outline" size={responsive.iconSize * 0.55} style={styles.IconColor} />
                    <Text style={styles.itemText}>Mostrar</Text>
                    <Ionicons name="chevron-forward-outline" size={responsive.iconSize * 0.45} style={styles.IconColor} />
                  </TouchableOpacity>
                    </>
                  )}
                </Animated.View>
